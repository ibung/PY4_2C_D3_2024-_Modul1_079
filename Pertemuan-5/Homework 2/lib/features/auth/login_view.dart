      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (_) => LogView(
            username: user,
            userId: user,
            userRole: _controller.getRoleFor(user),
            teamId: _controller.getTeamIdFor(user), // ← TAMBAH
          ),
        ),
      );
    } else {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: ClipOval(
                  child: Image.asset(
                      'assets/images/loginpage.jpg', fit: BoxFit.cover),
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      enabled: !isLocked,
                      decoration:
                          _inputDecor("Username", Icons.person_outline, _userError),
                    ),
                    ...
                    TextField(
                      ...
                      decoration: _inputDecor(
                              "Password", Icons.lock_outline, _passError)
                          .copyWith(
