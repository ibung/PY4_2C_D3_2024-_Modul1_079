...
class _LogViewState extends State<LogView> {
  ...
  // ── Dual-mode: FutureBuilder (online) + LogController (offline) ──
  ...
  // Helper parse ObjectId yang aman
  dynamic _tryParseObjectId(String id) {
    try {
      return id; // Logbook.id adalah ObjectId, tapi kita skip konversi
    } catch (_) {
      return null;
    }
  }
          ...
          children: [
            ...
            if (log.category != null)
              Container(
                ...
                child: Text(log.category!, style: const TextStyle(fontSize: 10)),
              ),
          ],
        ),
        subtitle: Column(
