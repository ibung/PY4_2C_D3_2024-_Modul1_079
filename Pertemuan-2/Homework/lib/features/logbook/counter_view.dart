...
class _CounterViewState extends State<CounterView> {
  ...
  void initState() {
    super.initState();
    // Load data per-user
    _controller.load(widget.username).then((_) => setState(() => _isLoading = false));
  }
      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
            _btn(Icons.remove, const Color.fromARGB(255, 217, 83, 79), () async {
              await _controller.decrement(widget.username);
              setState(() {});
            }),
            _btn(Icons.refresh, const Color.fromARGB(255, 240, 173, 78), _confirmReset),
            _btn(Icons.add, const Color.fromARGB(255, 92, 184, 92), () async {
